...
Este projeto é um sistema desenvolvido para gerenciar pedidos, clientes e produtos de uma fábrica de peças de carro. Ele permite realizar operações como cadastro, edição, listagem e exclusão de dados, além de autenticação de usuários.
...
Executar o projeto(cada comando em uma janela cmd):
...
Interpretação de códigos muito extensos
